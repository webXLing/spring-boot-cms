...
public class SkuController {
    ...
    @GetMapping("/by/spu")
   public List<SkuDO> getBySpuId(@RequestParam @Positive Long id){
        System.out.println(id);
        System.out.println("-----");
        LambdaQueryChainWrapper<SkuDO> eq = skuService.lambdaQuery().eq(SkuDO::getSpuId, id);
        List<SkuDO> list = eq.list();
        return list;
    }
